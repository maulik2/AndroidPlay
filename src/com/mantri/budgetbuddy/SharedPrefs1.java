...
public class SharedPrefs1 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setupVariables();
		//someData = getSharedPreferences(filename1,0);
	...
	public void onClick(View v) {
		...
		case R.id.bSave1:
			String stringData1 = sharedData1.getText().toString();
			SharedPreferences.Editor editor1 = someData1.edit();
			editor1.putString("sharedString1", stringData1);
			editor1.commit();
			break;
		case R.id.bLoad1:
			someData1 = getSharedPreferences(filename1, 0);
			String dataReturned1 = someData1.getString("sharedString1", "Couldn`t load Data");
			dataResults1.setText(dataReturned1);
			break;
			****/
		}
